...
# Ensure you rename sample_oci.env to oci.env and populate it with your credentials
load_dotenv('oci.env')
...
EMAIL_PASSWORD = os.getenv("EMAIL_PASSWORD", "").strip() if os.getenv("EMAIL_PASSWORD") else "REDACTED"
DISCORD_WEBHOOK = os.getenv("DISCORD_WEBHOOK", "").strip() if os.getenv("DISCORD_WEBHOOK") else "REDACTED"
